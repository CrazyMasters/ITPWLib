#
#  Be sure to run `pod spec lint ITPWLib.podspec' to ensure this is a
...
#      pod lib lint; git add .;git commit -m "fixed image (again)"; git push; git tag 0.2.26; git push origin 0.2.26; pod trunk push;
...
# pod lib lint; git add .;git commit -m "new vers"; git push; git tag 0.2.17; git push origin 0.2.17; pod trunk push;
  ...
  ITPW technical essentials
                   DESC

  spec.homepage     = "https://github.com/vladukhaDog/ITPWLib.git"
...
spec.swift_version = '5.0'
  ...
  spec.source       = { :git => "https://github.com/vladukhaDog/ITPWLib.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "ITPWLib", "ITPWLib/**/*.{h,m}"
